...
namespace ApplicationDemo.Infrastructure.Migrations
{
    ...
    [Migration("20230405015502_edit3")]
    partial class edit3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationDemo.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5f1adae4-5d12-4e60-bedd-613128a5ff90"),
                            Name = "Mobile"
                        },
                        new
                        {
                            Id = new Guid("6193b00a-31a2-4e28-a3ba-1de1be353296"),
                            Name = "Tablet"
                        },
                        new
                        {
                            Id = new Guid("c6f4c36b-38c6-4fde-95bf-fadbf288332b"),
                            Name = "LabTop"
                        });
                });
            ...
            modelBuilder.Entity("ApplicationDemo.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
